...
export class SideNavBarComponent {
  ...
  navigateToRequest(destination: string) {
    ...
    switch (destination) {
      case 'New Request':
        this.router.navigate(['/traveller/new-travel-request']);
        break;
      case 'Pending Approval':
        this.router.navigate(['/traveller/requests/pending']);
        break;
      case 'Approved Requests':
        this.router.navigate(['/traveller/requests/ongoing']);
        break;
      case 'Request History':
        this.router.navigate(['/traveller/requests/history']);
        break;
      case 'profile':
      ...
      case 'documents':
        this.router.navigate(['/traveller/documents']);
        break;
